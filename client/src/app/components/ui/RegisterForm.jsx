...
const RegisterForm = () => {
  ...
  const validatorConfig = {
    ...
    license: {
      isRequired: {
        message: 'Вы не можете использовать наш сервис без лицензионного согласшения',
      },
    },
  }
  ...
  return (
    <form onSubmit={handleFormSubmit}>
      <TextField label="Почта" name="email" value={formData.email} error={errors.email} onChange={handleChange} />
      <TextField label="Имя" name="name" value={formData.name} error={errors.name} onChange={handleChange} />
      <TextField
        label="Пароль"
        type="password"
        name="password"
      ...
      />
      <CheckBoxField onChange={handleChange} name="license" value={formData.license} error={errors.license}>
